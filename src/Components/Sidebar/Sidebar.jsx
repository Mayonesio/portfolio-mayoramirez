    ...
    return (
        <div className="bg-gray-100">
            <div className="h-screen flex overflow-hidden bg-gray-200">
                {/* Sidebar */}
                <div className={`absolute bg-gray-800 text-white w-56 min-h-screen overflow-y-auto transition-transform ${isOpen ? '' : 'transform -translate-x-full'} ease-in-out duration-300`} id="sidebar">
                    ...
                    <div className="bg-white shadow">
                        <div className="container mx-auto">
                            <div className="flex justify-between items-center py-4 px-2">
                                ...
                                <button onClick={toggleSidebar} className="text-gray-500 hover:text-gray-600" id="open-sidebar">
