            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <img loading="lazy" width="647" height="486"
                  ...
                  style={{ color: 'transparent' }} src="https://images.unsplash.com/photo-1569144157591-c60f3f82f137" alt="can_help_banner" />
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="mt-12 sm:mt-16 lg:mt-0">
              <div className="-mr-48 pl-6 md:-mr-16 lg:relative lg:m-0 lg:h-full lg:px-0">
                <img loading="lazy" width="646" height="485"
                  ...
                  src="https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e" alt="can_help_banner" />
              </div>
            </div>
          </div>
        </div>
